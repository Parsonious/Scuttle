...
{
    /// <summary>
    /// Scalar (non-SIMD) implementation of XChaCha20 for all platforms
    /// </summary>
    internal class XChaCha20ScalarStrategy : BaseXChaCha20Strategy
    {
        ...
        public static bool IsSupported => true; // Scalar implementation is always supported
    }
}
