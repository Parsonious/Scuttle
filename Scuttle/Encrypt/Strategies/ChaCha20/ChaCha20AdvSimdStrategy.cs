...
{
    /// <summary>
    /// ARM NEON (AdvSimd) optimized implementation of ChaCha20
    /// </summary>
    [SupportedOSPlatform("linux")]
    [SupportedOSPlatform("macos")]
    [SupportedOSPlatform("windows")]
    internal class ChaCha20AdvSimdStrategy : BaseChaCha20Strategy
    {
        ...
        protected override void GenerateKeyStreamInternal(Span<uint> initialState, Span<byte> keyStream)
        {
            ...
            // Update counter in initial state
            initialState[12] = counter;
        }

        /// <summary>
        /// Check if ARM Advanced SIMD is supported on the current hardware
        /// </summary>
